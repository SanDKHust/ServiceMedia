...
public class MyService extends Service {
        ...
        mMediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                if (currentMediaPlayer != null) {
                 // không gọi hàm callback ở đây sao bên activity nó nhân được??? currentMediaPlayer.onPrepared(mp.get....)
                }
            }
        });
        mMediaPlayer.start();
    ...
    private final Runnable mRunnable = new Runnable() {
        @Override
        public void run() {
                          // không gọi hàm callback ở đây sao bên activity nó nhân được??? currentMediaPlayer.updateSeekbar(mMediaPlayer.getCurrentPosition())
